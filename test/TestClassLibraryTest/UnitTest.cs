...
namespace TestClassLibraryTest
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethodWithReturnTypeAndParameters()
        {
            ...
            stub.SetupGetContactPhoneNumber_String_String((fn, ln) =>
            {
                firstName = fn;
                lastName = ln;
                return number;
        ...
        public void TestPropertyStubWithGetterAndSetter()
        {
            ...
            var stub = new StubIPhoneBook()
                .SetupMyNumber_Get(() => myNumber)
                .SetupMyNumber_Set(value => newNumber = value);
        ...
        public void TestPropertyStubWithGetterOnly()
        {
            ...
            var stub = new StubIPhoneBook().SetupContactsCount_Get(() => contactsCount);
            IPhoneBook phoneBook = stub;
        ...
        public void TestCallSequence()
        {
            ...
            var stub = new StubIPhoneBook().SetupGetContactPhoneNumber_String_String((p1, p2) => sequence.Next(p1, p2));
            IPhoneBook phoneBook = stub;
        ...
        public void TestGenericMethod()
        {
            ...
            var stub = new StubIContainer()
                .SetupGetElement_Int32<int>(index => value)
                .SetupSetElement_Int32_T<int>((i, v) => { value = v; });
        ...
        public void TestOutParameter()
        {
            object someObj = "test";
            var stub = new StubIContainer()
                .SetupGetElement_Int32_Object((int index, out object value) =>
                {
                    value = someObj;
                    return true;
                });
        ...
        public void TestRefParameter()
        {
            var stub = new StubIRefUtils()
                .SetupSwap_T_T<int>((ref int v1, ref int v2) =>
                {
                    int temp = v1;
                    v1 = v2;
                    v2 = temp;
